    ...
    <>
      <Container className="mt-24 sm:mt-32 md:mt-56">
        ...
        <h1 className="font-display text-5xl font-medium tracking-tight text-neutral-950 [text-wrap:balance] sm:text-7xl">
            Decentralsed venture capital for the <span className='font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-700/70 via-purple-800 to-pink-700/50'>Internet Computer.</span>
          </h1>
